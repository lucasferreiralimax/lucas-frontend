...
const Theme = () => {
  ...
  return (
    <button className='app-theme' data-testid='app-theme' onClick={changeTheme}>
      {themeValue &&
        <svg role='img' aria-label='Icon Dark Mode' fill='var(--main-color)' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64' width='25' height='25'>
      ...
      {!themeValue &&
        <svg role='img' aria-label='Icon Light Mode' fill='var(--main-color)' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 330 330' width='25' height='25'>
